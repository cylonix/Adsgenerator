...
Preview.prototype._onClick = function(e) {
  ...
  setTimeout(function() {
    // var banner = _this.iframe.contentWindow.document.querySelector('#ad-container');

    // if (banner) {
      TweenLite.set('.loading', { autoAlpha: 0 });
      TweenLite.to('.iframe iframe', 0.5, {autoAlpha: 1, ease: Expo.easeOut });
      TweenLite.from('.iframe iframe', 0.5, {y: "-=20", ease: Expo.easeOut});
    // }
...
Scrubber.prototype._scrub = function() {
  var progress = this.timeline.progress() * 100;
